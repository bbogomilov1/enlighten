    ...
    <div className={styles.container}>
      ...
      <div className={styles.description}>
        <p>
          ...
          език, но са различни методите, чрез които това се случва. Затова в
          ENlightEN предлагаме индивидуални уроци, с които да помогнем на децата
          да разберат и усвоят преподадения материал и да открият начините, по
          които самите те учат най-успешно, за да ги прилагат всеки път, когато
          се изправят пред нови уроци.
        </p>
        <p>
